...
void Drv_Lcd_Init(void)
{
    ...
    esp_lcd_panel_swap_xy(lcd_panel_handle, false);        // 竖屏：不交换 X/Y，逻辑 = 物理 240x320
    esp_lcd_panel_mirror(lcd_panel_handle, false, false);  // 竖屏默认不镜像（若方向颠倒再调）
